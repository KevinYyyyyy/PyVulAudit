...
class CallGraphGenerator(object):
    ...
    def _load_external_modules(self):
        all_external_deps = utils.dynamic_load.load_all_deps()
        for dep, dep_dir in all_external_deps.items():
    ...
    def do_pass(
        ...
        for entry_point in self.entry_points:
            ...
            # TODO: add_external_modules
            # self.module_manager.add_external_modules(input_mod)
            processor.analyze()
            # assert False
