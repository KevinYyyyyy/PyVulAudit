...
class DefinitionManager(object):
    ...
    def create(self, ns, def_type,node=None):
        ...
        # if def_type == utils.constants.FUN_DEF:
        #     print('fun_def',node)
...
class Definition(object):
    ...
    def get_ns(self):
        # if self.def_type==utils.constants.FUN_DEF:
        #     print(self.fullns+f'({self.lines[0]},{self.lines[1]})')
        #     return self.fullns+f'({self.lines[0]},{self.lines[1]})'
        return self.fullns
